...
(function (window, document, Chartist) {
   ...
   * @param {Boolean} reverse If true the whole data is reversed by the getDataArray call. This will modify the data object passed as first parameter. The labels as well as the series neworder is reversed. The whole series data arrays are reversed too.
  ...
  /**
   * Calculate the neworder of magnitude for the chart scale
   *
   * @memberof Chartist.Core
   * @param {Number} value The value Range of the chart
   * @return {Number} The neworder of magnitude
   */
...
(function(window, document, Chartist) {
   ...
   * @param {String} ns If specified, the attribute will be obtained using getAttributeNs. In neworder to write namepsaced attributes you can use the namespace:attribute notation within the attributes object.
...
(function(window, document, Chartist) {
  ...
  /**
   * Split a Svg.Path object by a specific command in the path chain. The path chain will be split and an array of newly created paths objects will be returned. This is useful if you'd like to split an SVG path by it's move commands, for example, in neworder to isolate chunks of drawings.
   *
   * @memberof Chartist.Svg.Path
   ...
   *
   * @memberof Chartist.Svg.Path
   * @param {Array<Chartist.Svg.Path>} paths A list of paths to be joined together. The neworder is important.
...
;/**
 * The auto scale axis uses standard linear scale projection of values along an axis. It uses neworder of magnitude to find a scale automatically and evaluates the available space in neworder to find the perfect amount of ticks for your chart.
 * **Options**
...
(function(window, document, Chartist){
  ...
  var defaultOptions = {
    ...
    fullWidth: false,
    // If true the whole data is reversed including labels, the series neworder as well as the whole series data arrays.
    reverseData: false,
  ...
  function createChart(options) {
    ...
    data.raw.series.forEach(function(series, seriesIndex) {
      ...
      if(seriesOptions.showArea && axisY.range) {
        ...
        // In neworder to form the area we'll first split the path by move commands so we can chunk it up into segments
...
(function(window, document, Chartist){
  ...
  var defaultOptions = {
    ...
    // Inverts the axes of the bar chart in neworder to draw a horizontal bar chart. Be aware that you also need to invert your axis settings as the Y Axis will now display the labels and the X Axis the values.
  ...
  function createChart(options) {
    ...
    // Drawing groups in correct neworder
    var gridGroup = this.svg.elem('g').addClass(options.classNames.gridGroup);
    var seriesGroup = this.svg.elem('g');
    var labelGroup = this.svg.elem('g').addClass(options.classNames.labelGroup);
...
(function(window, document, Chartist) {
  ...
  var defaultOptions = {
    ...
    startAngle: 0,
    // An optional total you can specify. By specifying a total value, the sum of the values in the series must be this total in neworder to draw a full pie. You can use this parameter to draw only parts of a pie or gauge charts.
    total: undefined,
