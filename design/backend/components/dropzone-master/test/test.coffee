...
describe "Dropzone", ->
  ...
  describe "init()", ->
    describe "clickable", ->
      ...
      dropzones =
        "using acceptedFiles": new Dropzone(Dropzone.createElement("""<form action="/"></form>"""<form action="/"></form>"""<form action="/"></form>"""), { clickable: yes, acceptedFiles: "audio/*,video/*" })
        "using acceptedMimeTypes": new Dropzone(Dropzone.createElement("""<form action="/"></form>"""<form action="/"></form>"""<form action="/"></form>"""), { clickable: yes, acceptedMimeTypes: "audio/*,video/*" })

      it "should not add an accept attribute if no acceptParameter", ->
        dropzone = new Dropzone (Dropzone.createElement """<form action="/"></form>"""<form action="/"></form>"""<form action="/"></form>"""), clickable: yes, acceptParameter: null, acceptedMimeTypes: null
    ...
    it "should create a .dz-message element", ->
      element = Dropzone.createElement """<form class="dropzone" action="/"></form>"""<form class="dropzone" action="/"></form>"""<form class="dropzone" action="/"></form>"""
